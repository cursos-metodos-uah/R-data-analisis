---
title: "Trabajo 4. Regresión lineal y regresión logística"
subtitle: "R para análisis estadístico"
linktitle: "Trabajo 4. Regresión lineal y regresión logística"
date: "2026-06-15"
lang: es
---
...
El objetivo de este trabajo es realizar un reporte dinámico a través de Quarto, que contenga el análisis descriptivo (trabajo 2) del problema de investigación propuesto, la visualización e interpretación de la asociación de estas variables (trabajo 3) y la estimación e interpretación de modelos de regresión. El documento final debe ser subido a Github Pages y se debe enviar el link a este documento para su revisión.
