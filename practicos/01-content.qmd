...
1) Generar un primer acercamiento al uso de R y Rstudio, conociendo su interfaz y sus principales funcionalidades 
...
- `guaguas`: Paquete que contiene los datos de nombres de guaguas (bebés) registrados en Chile entre 1920 y 2021 según el Registro Civil e Identificación. Paquete de R creado por [Riva Quiroga](https://rivaquiroga.cl/), más información [acá](https://github.com/rivaquiroga/guaguas)
